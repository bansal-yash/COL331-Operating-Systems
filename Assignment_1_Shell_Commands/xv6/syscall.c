...
// Declaring new system call functions
////////////////////////////////////////////////////////////////////////
...
static int (*syscalls[])(void) = {
    ...
    // Mapping the new system call functions to the system call identifier
    ////////////////////////////////////////////////////////////////////////
...
void syscall(void)
{
    ...
    if (curproc->parent)
    {
        ...
        {
            if (curproc->sh_calls == 1)
            {
                int block_bit_vector = curproc->parent->parent->block_bit_vector;
                is_blocked = (block_bit_vector >> num) & 1;
