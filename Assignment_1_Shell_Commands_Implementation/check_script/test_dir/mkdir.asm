...
main(int argc, char *argv[])
{
  ...
  4a:	ff 36                	pushl  (%esi)
  4c:	e8 09 02 00 00       	call   25a <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2fd:	43                   	inc    %ebx
 2fe:	8a 92 80 06 00 00    	mov    0x680(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3c0:	ff 24 85 28 06 00 00 	jmp    *0x628(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 425:	75 13                	jne    43a <printf+0xf5>
          s = "(null)";
 427:	be 1f 06 00 00       	mov    $0x61f,%esi
...
free(void *ap)
{
 ...
 4b1:	a1 94 06 00 00       	mov    0x694,%eax
 ...
 4ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4ef:	a3 94 06 00 00       	mov    %eax,0x694
}
 4f4:	5b                   	pop    %ebx
 4f5:	5e                   	pop    %esi
 4f6:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 54c:	e8 54 ff ff ff       	call   4a5 <free>
  return freep;
 551:	a1 94 06 00 00       	mov    0x694,%eax
...
malloc(uint nbytes)
{
 ...
 575:	43                   	inc    %ebx
  if((prevp = freep) == 0){
 576:	8b 0d 94 06 00 00    	mov    0x694,%ecx
 ...
 582:	eb 4a                	jmp    5ce <malloc+0x69>
    base.s.ptr = freep = prevp = &base;
 584:	c7 05 94 06 00 00 98 	movl   $0x698,0x694
 58b:	06 00 00 
 58e:	c7 05 98 06 00 00 98 	movl   $0x698,0x698
 595:	06 00 00 
    base.s.size = 0;
 598:	c7 05 9c 06 00 00 00 	movl   $0x0,0x69c
 59f:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5a2:	b9 98 06 00 00       	mov    $0x698,%ecx
 ...
 5b3:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5b6:	89 0d 94 06 00 00    	mov    %ecx,0x694
      return (void*)(p + 1);
 ...
 5d3:	73 d4                	jae    5a9 <malloc+0x44>
    if(p == freep)
 5d5:	39 05 94 06 00 00    	cmp    %eax,0x694
